...
#df('TestCaseDistribution.pdf', width=16, height=5, pointsize=32, family='CMU Serif')
svg('TestCaseDistribution.svg', width=16, height=5, pointsize=32, family='CMU Serif')

data <- read.csv('TestcaseDistributions.txt', sep='\t', header=FALSE)
par(mar=c(1, 6, 0.5, 3))
hist(data$V1, breaks=220, col='black', main='', xlim=c(0, 220), ylim=c(0, 80), xaxt='n', ylab='')
...
#pdf('TreeSize.pdf', width=16, height=5, pointsize=32, family='CMU Serif')
svg('TreeSize.svg', width=16, height=5, pointsize=32, family='CMU Serif')
